...
var Random = (function (root) {
  ...
  function Random(engine) {
    if (!(this instanceof Random)) {
      throw new TypeError("Expected to be called with new");
    }
  ...
  Random.pick = function (engine, array) {
    var distribution = Random.integer(0, (array.length - 1) >>> 0);
    return array[distribution(engine)];
  };
  proto.pick = function (array) {
    return Random.pick(this.engine, array);
  };

  var slice = Array.prototype.slice;
  Random.picker = function (array) {
